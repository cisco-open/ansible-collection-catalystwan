cisco_omp_definition = {
    "cisco_omp": {
        ...
        "options": {
            ...
            "auto_translate": {"default": None, "required": False, "type": "str"},
            "ecmp_limit": {"default": None, "required": False, "type": "str"},
            ...
            "ignore_region_path_length": {"default": None, "required": False, "type": "str"},
            "ipv6_advertise": {
                "default": None,
                "elements": "dict",
            ...
            "omp_admin_distance_ipv4": {"default": None, "required": False, "type": "str"},
            "omp_admin_distance_ipv6": {"default": None, "required": False, "type": "str"},
            "overlay_as": {"default": None, "required": False, "type": "str"},
